...
<body data-container="body" id="html-body"
      class="pl8a page-with-filter page-products categorypath-dziecko category-dziecko catalog-category-view page-layout-2columns-left no-tablet"
      aria-busy="false">
...
<footer id="footer" class="js-footer page-footer">
  {block name="footer"}
