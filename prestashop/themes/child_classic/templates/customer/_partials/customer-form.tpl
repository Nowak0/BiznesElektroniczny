...
<form action="{block name='customer_form_actionurl'}{$action}{/block}" id="customer-form" class="js-customer-form" method="post">
  <div>
    ...
    <div class="form-group row ">
      ...
      <div class="col-md-6">
        <div class="input-group js-parent-focus">
          {literal}
          <input id="field-password" class="form-control js-child-focus js-visible-password" name="password" title="Co najmniej 5 znaków" aria-label="Hasło musi zawierać przynajmniej 5 znaków" type="password" value="" pattern=".{5,}" required="">
          {/literal}
    ...
    <div class="form-group row ">
      ...
      <div class="col-md-6">
        <span class="custom-checkbox">
          <label>
            <input name="agreement_1" type="checkbox" value="1" required="">
            <span><i class="material-icons rtl-no-flip checkbox-checked"></i></span>
            Niniejszym wyrażam zgodę na przetwarzanie moich danych osobowych przez Orzełek.it z siedzibą w Kłobuck (42-100) przy ul. Wojska Polskiego 15, zarejestrowaną w Kłobuck, nr NIP: 5741882651, nr REGON: 385285808 na potrzeby i w zakresie niezbędnym do korzystania przeze mnie z usług świadczonych przez Orzełek.it, w tym na przekazywanie moich danych osobowych podmiotom trzecim, przy pomocy których Orzełek.it świadczy usługi związane z realizacją zamówień oraz obsługą płatności.
          </label>
        </span>
      </div>
      <div class="col-md-3 form-control-comment"></div>
    ...
    <div class="col-md-6" style="display: none;">
      <span class="custom-checkbox">
        <label>
          <input name="customer_privacy" type="checkbox" value="1" required="" checked>
          <span><i class="material-icons rtl-no-flip checkbox-checked"></i></span>
              Wiadomość o przetwarzaniu danych osobowych <br><em>The personal data you provide is used to answer queries, process orders or allow access to specific information. You have the right to modify and delete all the personal information found in the "My Account" page.</em>
        </label>
      </span>
