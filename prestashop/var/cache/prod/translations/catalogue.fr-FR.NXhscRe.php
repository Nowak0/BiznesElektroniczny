...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Send me an email when the quantity is under this level' => 'M\'envoyer un e-mail quand la quantité est en dessous de ce niveau',
  ...
  array (
    ...
    'Image URLs (x,y,z...)' => 'URLs des images (x,y,z, etc.)',
  ...
  array (
    ...
    'Enable this option if you want to allow accented characters in your friendly URLs.' => 'Activez cette option si vous souhaitez autoriser les accents dans vos URLs simplifiées.',
...
',
  ...
  array (
    ...
    'Error: Could not write to file. Make sure that the correct permissions are set on the file %s' => 'Erreur : impossible de modifier le fichier. Assurez-vous que les droits sont correctement paramétrés sur le fichier %s.',
    'Error: Could not find whether debug mode is enabled. Make sure that the correct permissions are set on the file %s' => 'Erreur : impossible de savoir si l\'outil de debug est activé. Assurez-vous que les droits sont correctement paramétrés sur le fichier %s.',
  ...
  array (
    ...
    'Number of threads displayed' => 'Nombre de discussions affichées',
    'Number of threads displayed in the block (default value: 5).' => 'Nombre de discussions affichées dans le bloc (par défaut : 5).',
  ),
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'Adapt your offer to your market: add the most popular payment methods for your customers!' => 'Adaptez votre offre à votre marché : ajoutez les moyens de paiement les plus populaires auprès de vos clients !',
  ...
  array (
    ...
    'Your avatar in PrestaShop 1.7.x is your profile picture on %url%. To change your avatar, log in to PrestaShop.com with your email %email% and follow the on-screen instructions.' => 'Dans PrestaShop 1.7.x, votre photo de profil sur %url% vous sert d\'avatar. Pour changer votre avatar, connectez-vous sur PrestaShop.com avec l\'e-mail %email% et suivez les instructions.',
...
clients grâce à la liste de vos meilleures ventes.',
  ...
  array (
    ...
    'This email address is not valid. Please use an address like bob@example.com.' => 'Cette adresse e-mail n\'est pas valide. L\'adresse e-mail doit suivre le format jean@exemple.com.',
