...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected static function getShipmentRepositoryService($container, $lazyLoad = true)
    {
        ...
        return ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container))->getRepository('PrestaShopBundle\\Entity\\Shipment');
    }
    ...
    {
        return $container->services['prestashop.adapter.employee_language_updater'] = new \PrestaShop\PrestaShop\Adapter\Employee\EmployeeLanguageUpdater(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ps_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PS_LANG_DEFAULT"));
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/html/var/cache/dev//localization');
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(true, 'dev', 'front')), '/var/www/html') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['/var/www/html/src/PrestaShopBundle/Entity']), 'PrestaShop');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['/var/www/html/modules/productcomments/src/Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        ...
        $instance->setProxyDir('/var/www/html/var/cache/dev//doctrine/orm/Proxies');
...
class ShipmentRepositoryProxyA991ae4 extends \PrestaShopBundle\Entity\Repository\ShipmentRepository implements \Symfony\Component\VarExporter\LazyObjectInterface
{
    ...
    public function mergeProductsToShipment(\PrestaShopBundle\Entity\Shipment $source, \PrestaShopBundle\Entity\Shipment $target, array $shipmentProducts): void
    {
        if (isset($this->lazyObjectState)) {
            ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->mergeProductsToShipment(...\func_get_args());
        } else {
            parent::mergeProductsToShipment(...\func_get_args());
        }
    }

    public function splitShipment(int $carrierId, \PrestaShopBundle\Entity\Shipment $shipmentToRemoveProduct, array $shipmentProductsToMove): void
    {
        if (isset($this->lazyObjectState)) {
            ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->splitShipment(...\func_get_args());
        } else {
            parent::splitShipment(...\func_get_args());
        }
    }
}
