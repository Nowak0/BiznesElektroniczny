...
class getUpdateProductTypeHandlerService extends AdminKernelDevDebugContainer
{
    ...
    {
        return $container->services['PrestaShop\\PrestaShop\\Adapter\\Product\\CommandHandler\\UpdateProductTypeHandler'] = new \PrestaShop\PrestaShop\Adapter\Product\CommandHandler\UpdateProductTypeHandler(new \PrestaShop\PrestaShop\Adapter\Product\Update\ProductTypeUpdater(($container->services['PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository'] ?? $container->load('getProductRepositoryService')), ($container->privates['PrestaShop\\PrestaShop\\Adapter\\Product\\Pack\\Update\\ProductPackUpdater'] ?? $container->load('getProductPackUpdaterService')), ($container->privates['PrestaShop\\PrestaShop\\Adapter\\Product\\Combination\\Update\\CombinationDeleter'] ?? $container->load('getCombinationDeleterService')), ($container->privates['PrestaShop\\PrestaShop\\Adapter\\Product\\VirtualProduct\\Update\\VirtualProductUpdater'] ?? $container->load('getVirtualProductUpdaterService')), ($container->privates['PrestaShop\\PrestaShop\\Adapter\\Product\\Stock\\Update\\ProductStockUpdater'] ?? $container->load('getProductStockUpdaterService')), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Product\\Pack\\Repository\\ProductPackRepository'] ?? $container->load('getProductPackRepositoryService'))));
    }
}
