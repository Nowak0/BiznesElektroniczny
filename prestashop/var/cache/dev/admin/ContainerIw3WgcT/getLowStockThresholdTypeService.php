 ...
 */
class getLowStockThresholdTypeService extends AdminKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\LowStockThresholdType'] = new \PrestaShopBundle\Form\Admin\Sell\Product\Combination\LowStockThresholdType(($container->services['translator'] ?? self::getTranslatorService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), $a);
    }
}
