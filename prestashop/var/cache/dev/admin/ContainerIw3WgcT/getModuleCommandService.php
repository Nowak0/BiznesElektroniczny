...
class getModuleCommandService extends AdminKernelDevDebugContainer
{
    ...
    {
        return $container->services['PrestaShopBundle\\Command\\ModuleCommand'] = new \PrestaShopBundle\Command\ModuleCommand(($container->services['translator'] ?? self::getTranslatorService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container)), ($container->services['.container.private.prestashop.adapter.module.self_configurator'] ?? $container->load('get_Container_Private_Prestashop_Adapter_Module_SelfConfiguratorService')), ($container->services['PrestaShop\\PrestaShop\\Core\\Module\\ModuleManager'] ?? $container->load('getModuleManagerService')), ($container->services['PrestaShop\\PrestaShop\\Core\\Context\\ContextBuilderPreparer'] ?? $container->load('getContextBuilderPreparerService')), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration()));
    }
}
