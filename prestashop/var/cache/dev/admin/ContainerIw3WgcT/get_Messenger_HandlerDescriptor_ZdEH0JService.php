 ...
 */
class get_Messenger_HandlerDescriptor_ZdEH0JService extends AdminKernelDevDebugContainer
{
    /**
    ...
    {
        $a = ($container->services['PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository'] ?? $container->load('getProductRepositoryService'));
