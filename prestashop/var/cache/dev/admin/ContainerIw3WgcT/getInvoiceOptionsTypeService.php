...
class getInvoiceOptionsTypeService extends AdminKernelDevDebugContainer
{
    ...
    {
        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Order\\Invoices\\InvoiceOptionsType'] = new \PrestaShopBundle\Form\Admin\Sell\Order\Invoices\InvoiceOptionsType(($container->services['translator'] ?? self::getTranslatorService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), ($container->services['.container.private.prestashop.core.form.choice_provider.invoice_model_by_name'] ?? $container->load('get_Container_Private_Prestashop_Core_Form_ChoiceProvider_InvoiceModelByNameService')), ($container->services['prestashop.adapter.data_provider.order_invoice'] ??= new \PrestaShop\PrestaShop\Adapter\Invoice\OrderInvoiceDataProvider())->getNextInvoiceNumber());
    }
}
