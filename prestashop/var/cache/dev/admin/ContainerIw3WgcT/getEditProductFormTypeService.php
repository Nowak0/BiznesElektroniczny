...
class getEditProductFormTypeService extends AdminKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\EditProductFormType'] = new \PrestaShopBundle\Form\Admin\Sell\Product\EditProductFormType(($container->services['translator'] ?? self::getTranslatorService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), ($container->services['.container.private.form.type.sell.product.event_listener.product_type_listener'] ?? $container->load('get_Container_Private_Form_Type_Sell_Product_EventListener_ProductTypeListenerService')), $a);
    }
}
