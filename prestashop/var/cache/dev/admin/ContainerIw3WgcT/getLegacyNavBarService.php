...
class getLegacyNavBarService extends AdminKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        $container->factories['service_container']['PrestaShopBundle\\Twig\\Component\\Legacy\\LegacyNavBar'] = function ($container) {
            ...
            return new \PrestaShopBundle\Twig\Component\Legacy\LegacyNavBar(($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container)), ($container->services['logger'] ?? self::getLoggerService($container)), $a, '9.1.0');
        };
