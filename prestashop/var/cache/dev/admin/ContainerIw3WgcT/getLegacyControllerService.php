...
class getLegacyControllerService extends AdminKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.KctCvNK'] ?? $container->load('get_ServiceLocator_KctCvNKService'))->withContext('PrestaShopBundle\\Controller\\Admin\\LegacyController', $container));
