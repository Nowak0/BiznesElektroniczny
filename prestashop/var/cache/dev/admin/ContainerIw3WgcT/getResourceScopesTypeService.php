 ...
 */
class getResourceScopesTypeService extends AdminKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['PrestaShopBundle\\Form\\Admin\\AdvancedParameters\\AdminAPI\\ResourceScopesType'] = new \PrestaShopBundle\Form\Admin\AdvancedParameters\AdminAPI\ResourceScopesType(($container->services['translator'] ?? self::getTranslatorService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), ($container->privates['PrestaShopBundle\\ApiPlatform\\Scopes\\CachedApiResourceScopesExtractor'] ?? $container->load('getCachedApiResourceScopesExtractorService')), $a);
    }
}
